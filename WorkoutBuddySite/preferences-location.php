    ...
    <div class="main-container">
        ...
        <div class="content">
        	<ul id="barSubmenu">
                ...
                <li><a class="current" href="preferences-location.php">Location</a></li>
                <li><a href="preferences-exercise.php">Exercise</a></li>
       		</ul>
            <div class="subcontent">
                <p>Your location helps us suggest new people near you that you can exercise with.</p>
                <div class="inputGroup">                	
                    <label for="slctCountry">Country:</label>
                    <select name="slctCountry"> 
                        <option value=""></option> 
                ...
                <div class="inputGroup">
                    ...
                    <input type="text" name="txtZip" value="92617" />
                </div>
                <div class="inputGroup">
                    <label for="txtAllow">Show me in "People Near You" lists:</label>                    
                    <input type="checkbox" name="txtAllow" checked="checked" />
                </div>
                <div class="inputGroup">
                    <p></p>
